...
var pylon2set = [pylonSets.empty, pylonSets.R3R, pylonSets.R13M, pylonSets.R60M, pylonSets.s24lb];
var pylon3set = [pylonSets.empty, pylonSets.fueltank];
var pylon4set = [pylonSets.empty, pylonSets.R3R, pylonSets.R13M, pylonSets.R60M, pylonSets.s24lc];
...
fcs = fc.FireControl.new(pylons, [5, 0, 4, 1, 3], ["23mm Cannon", "R-3R", "R-13M", "R-24R", "R-24T", "R-60M", "UB-32", "FAB-500", "RBK-500", "S-24"]);
