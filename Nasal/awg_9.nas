...
var myRadarStrength_rcs = 3.2;#getprop("instrumentation/radar/ref-strength");
var myRadarRange_rcs = 70;#getprop("instrumentation/radar/ref-range");
        ...
        if (scan_update_tgt_list)
        {
            ...
            foreach( var c; raw_list )
            {
                ...
                if (type == "multiplayer" or type == "tanker" or type == "aircraft" or type == "carrier"
                    or type == "ship" or type == "groundvehicle" or type == "Mig-28" or type == "F-16") 
                {
...
wcs_mode_sel(wcs_mode_pulse_srch);
...
#        }
    ...
    isRadiating: func (coord) {
        me.rn = me.get_range();
        if (me.get_model() != "gci" and me.get_model() != "buk-m2" and me.get_model() != "missile_frigate" and me.get_model() != "s-300" and me.get_type()!=MARINE) {
